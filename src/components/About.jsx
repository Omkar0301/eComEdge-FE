              ...
              <div className="flex flex-col items-center lg:flex-row lg:items-start">
                ...
                <div className="w-full px-0 lg:w-1/2 lg:pl-8 xl:pl-12">
                  <div className="max-w-[565px] mx-auto lg:ml-auto lg:mr-0">
                    {/* About Us Content */}
                    <div
                      className={`transition-opacity duration-300 ${activeTab === "about" ? "block opacity-100" : "hidden opacity-0"}`}
                    >
                      ...
                      <p className="mb-4 text-base text-dark-text md:mb-6">
                        ...
                        deserunt quidem dolores accusamus sit quod enim
                        nesciunt!
                      </p>
                    ...
                    {/* Our Mission Content */}
                    <div
                      className={`transition-opacity duration-300 ${activeTab === "mission" ? "block opacity-100" : "hidden opacity-0"}`}
                    >
                      <h2 className="font-heading text-dark mb-6 text-2xl font-bold sm:text-3xl md:mb-8 md:text-[40px] md:leading-[50px] dark:text-white">
                      ...
                      <p className="text-base text-dark-text">
                        We strive to empower businesses with tools that drive
                    ...
                    {/* Our Vision Content */}
                    <div
                      className={`transition-opacity duration-300 ${activeTab === "vision" ? "block opacity-100" : "hidden opacity-0"}`}
                    >
                      <h2 className="font-heading text-dark mb-6 text-2xl font-bold sm:text-3xl md:mb-8 md:text-[40px] md:leading-[50px] dark:text-white">
