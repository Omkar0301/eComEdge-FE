...
function Support() {
  ...
  return (
    <section
      id="support"
      className="relative mt-30 pt-20 py-24 overflow-hidden bg-gray-100 dark:bg-gray-900"
    >
      {/* Decorative elements */}
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center text-black dark:text-blue-400 "
                    >
                      support@startup.com
              ...
              <div className="h-full bg-white dark:bg-gray-800 rounded-2xl p-8 md:p-10">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center">
                    ...
                    <label
                      htmlFor="terms"
                      className="ml-5 text-sm text-gray-600 dark:text-gray-400"
                    >
                  ...
                  <button
                    ...
                    className={`w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center ${
