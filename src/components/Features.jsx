          ...
          <div className="container mx-auto px-4 py-12">
            <div className="flex flex-wrap -mx-4">
              ...
              <div className="w-full px-4 mb-8 md:w-1/2 lg:w-1/3">
                <div className="group mx-auto max-w-[350px] text-center h-full flex flex-col">
                  <div className="bg-primary/5 text-primary group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white md:mb-8 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white">
                    <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current"><path d="M3.66663 23.8333H14.6666V38.5H3.66663V23.8333ZM16.5 5.5H27.5V38.5H16.5V5.5Z"></path><path opacity="0.5" d="M29.3333 14.6667H40.3333V38.5H29.3333V14.6667Z"></path></svg>
                  </div>
                  <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-4 dark:text-white">
                    Crafted for SaaS Business
                  </h3>
                  <p className="text-dark-text text-base flex-grow">
              ...
              <div className="w-full px-4 mb-8 md:w-1/2 lg:w-1/3">
                <div className="group mx-auto max-w-[350px] text-center h-full flex flex-col">
                  <div className="bg-primary/5 text-primary group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white md:mb-8 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white">
                    <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current"><path d="M36.6667 40.3334H7.33333C6.8471 40.3334 6.38079 40.1402 6.03697 39.7964C5.69315 39.4526 5.5 38.9863 5.5 38.5V14.6667H38.5V38.5C38.5 38.9863 38.3068 39.4526 37.963 39.7964C37.6192 40.1402 37.1529 40.3334 36.6667 40.3334ZM12.8333 20.1667V27.5H20.1667V20.1667H12.8333ZM12.8333 31.1667V34.8334H31.1667V31.1667H12.8333ZM23.8333 22V25.6667H31.1667V22H23.8333Z"></path><path opacity="0.5" d="M38.5 11H5.5V5.49996C5.5 5.01373 5.69315 4.54741 6.03697 4.2036C6.38079 3.85978 6.8471 3.66663 7.33333 3.66663H36.6667C37.1529 3.66663 37.6192 3.85978 37.963 4.2036C38.3068 4.54741 38.5 5.01373 38.5 5.49996V11Z"></path></svg>
                  </div>
                  <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-4 dark:text-white">
              ...
              <div className="w-full px-4 mb-8 md:w-1/2 lg:w-1/3">
                <div className="group mx-auto max-w-[350px] text-center h-full flex flex-col">
                  <div className="bg-primary/5 text-primary group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white md:mb-8 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white">
                    <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current"><path d="M25.6667 38.5H7.33333C6.8471 38.5 6.38079 38.3068 6.03697 37.963C5.69315 37.6192 5.5 37.1529 5.5 36.6667V18.3333H25.6667V38.5ZM38.5 14.6667H5.5V7.33333C5.5 6.8471 5.69315 6.38079 6.03697 6.03697C6.38079 5.69315 6.8471 5.5 7.33333 5.5H36.6667C37.1529 5.5 37.6192 5.69315 37.963 6.03697C38.3068 6.38079 38.5 6.8471 38.5 7.33333V14.6667Z"></path><path opacity="0.5" d="M29.3334 38.5V18.3334H38.5V36.6667C38.5 37.1529 38.3069 37.6193 37.9631 37.9631C37.6193 38.3069 37.1529 38.5 36.6667 38.5H29.3334Z"></path></svg>
                  </div>
                  <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-4 dark:text-white">
                    Fully Customizable
                  </h3>
              ...
              <div className="w-full px-4 mb-8 md:w-1/2 lg:w-1/3">
                <div className="group mx-auto max-w-[350px] text-center h-full flex flex-col">
                  <div className="bg-primary/5 text-primary group-hover:bg-primary mx-auto mb-6 flex h-[70px] w-[70px] items-center justify-center rounded-full transition group-hover:text-white md:mb-8 md:h-[90px] md:w-[90px] dark:bg-white/5 dark:text-white">
                    <svg width="44" height="44" viewBox="0 0 44 44" className="fill-current"><path opacity="0.5" d="M10.0154 8.12714C13.3421 5.24452 17.598 3.6605 21.9999 3.66664C32.1254 3.66664 40.3332 11.8745 40.3332 22C40.3332 25.916 39.1049 29.546 37.0149 32.5233L31.1665 22H36.6665C36.6668 19.1246 35.8218 16.3126 34.2368 13.9136C32.6517 11.5146 30.3964 9.63443 27.7514 8.50687C25.1063 7.37931 22.1882 7.0541 19.3598 7.57168C16.5314 8.08926 13.9175 9.42679 11.8432 11.418L10.0154 8.12714Z"></path><path d="M33.9843 35.8729C30.6576 38.7555 26.4017 40.3395 21.9998 40.3333C11.8743 40.3333 3.6665 32.1255 3.6665 22C3.6665 18.084 4.89484 14.454 6.98484 11.4767L12.8332 22H7.33317C7.33293 24.8754 8.17788 27.6874 9.76295 30.0864C11.348 32.4854 13.6033 34.3656 16.2483 35.4931C18.8934 36.6207 21.8115 36.9459 24.6399 36.4283C27.4683 35.9107 30.0822 34.5732 32.1565 32.582L33.9843 35.8729Z"></path></svg>
                  </div>
                  <h3 className="font-heading text-dark mb-3 text-xl font-medium sm:text-2xl md:mb-4 dark:text-white">
                    Regular Updates
                  </h3>
